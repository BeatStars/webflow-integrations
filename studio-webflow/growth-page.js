...
const fullPage = createApp({
    ...
    async beforeMount() {
        ...
        this.plan = await getSinglePlan("Growth", token, this.graphUrl);
    },
    methods: {
        ...
        testMethod() {
            ...
            // let isOnboarded = await verifyUserOnboard(token)
            // return window.location.href =
            //   `https://www.beatstars.com/onboarding/subscription-checkout?onboardingType=seller&backEnabled=false&plan=marketplace&paymentFrequency=YEAR`
        }
    },
    mounted() {
